...
# CONFIG
# =====================
DATA_DIR = Path("dataset/severity")   # has train/val/test with Healthy, Early, Intermediate, Final
BATCH_SIZE = 16
EPOCHS = 30
LR = 1e-4
SEED = 42
NUM_CLASSES = 4  # Healthy, Early (0.1-3%), Intermediate (3-12%), Final (≥12%)

# Output model weights
WEIGHTS_OUT = Path("models/mango_severity_resnet50.pth")
...
# TRANSFORMS
# =====================
# Data augmentation for training - following the study's approach
...
print("\n" + "="*60)
print("SEVERITY CLASSES MAPPING")
print("="*60)
...
# =====================
# MODEL - ResNet50 (as per the study)
# =====================
print("\n" + "="*60)
print("LOADING ResNet50 MODEL")
print("="*60)
print("Architecture: ResNet50 (following the severity estimation study)")
print("Pre-trained: ImageNet weights")
print("="*60 + "\n")

model = models.resnet50(weights=models.ResNet50_Weights.DEFAULT)

# Replace final fully connected layer for 4 severity classes
...
for epoch in range(1, EPOCHS + 1):
    ...
    if epoch == FREEZE_EPOCHS + 1:
        ...
        print("[OK] Backbone unfrozen (fine-tuning all layers).")
